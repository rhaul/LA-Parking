...
package aaremm.com.laparking.views;
 ...
 */
public class TouchHighlightIB extends ImageButton {
    /**
    ...
    public TouchHighlightIB(Context context) {
        super(context);
        init();
    }

    public TouchHighlightIB(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TouchHighlightIB(Context context, AttributeSet attrs, int defStyle) {
